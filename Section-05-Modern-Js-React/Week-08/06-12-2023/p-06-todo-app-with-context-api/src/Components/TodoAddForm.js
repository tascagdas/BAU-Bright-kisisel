            ...
            <form onSubmit={handleSubmit}>
                <div className="input-group mb-3">
                    ...
                    <div className='btn-group' role='group'>
                        <button className="btn btn-success" type="submit" id="btn-add-task"><FontAwesomeIcon className='fs-2' icon={faSquarePlus} size="xl" /></button>
                        <button className="btn btn-danger" type="button" id="btn-clear-task" onClick={() => { context.clearAll() }}><FontAwesomeIcon className='fs-2' icon={faBroom} /></button>
                    </div>
