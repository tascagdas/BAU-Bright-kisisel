...
(function(mod) {
  ...
  var defaultKeymap = [
    ...
    { keys: 'Y', type: 'operatorMotion', operator: 'yank', motion: 'expanViewModelLine', motionArgs: { linewise: true }, context: 'normal'},
  ...
  var Vim = function() {
      ...
      processOperator: function(cm, vim, command) {
        ...
        if (inputState.operator) {
          if (inputState.operator == command.operator) {
            ...
            // linewise
            inputState.motion = 'expanViewModelLine';
    ...
    var motions = {
      ...
      expanViewModelLine: function(_cm, head, motionArgs) {
      ...
      findAndSelectNextInclusive: function(cm, _head, motionArgs, vim, prevInputState) {
        ...
        // next: [from, to] | null
        var next = findNextFromAnViewModelInclusive(cm, prev, query, motionArgs.repeat, vim);
    ...
    * in the right place.
     ...
     */
    function findNextFromAnViewModelInclusive(cm, prev, query, repeat, vim) {
      if (repeat === undefined) { repeat = 1; }
      return cm.operation(function() {
        var pos = cm.getCursor();
        var cursor = cm.getSearchCursor(query, pos);
