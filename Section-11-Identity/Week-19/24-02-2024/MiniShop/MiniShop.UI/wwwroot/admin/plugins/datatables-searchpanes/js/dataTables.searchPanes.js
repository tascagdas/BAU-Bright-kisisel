...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
            ...
            }, this.c.ViewModelpts, colOpts !== undefined ? colOpts.ViewModelpts : {}, this.s.colOpts.options !== undefined || !this.colExists ?
                {
                    createdRow: function (row, data, dataIndex) {
                        $(row).addClass(data.className);
                    }
                } :
                undefined, this.customPaneSettings !== null && this.customPaneSettings.ViewModelpts !== undefined ?
                this.customPaneSettings.ViewModelpts :
        ...
        SearchPane.prototype._displayPane = function () {
            ...
            this.dom.upper.appenViewModel(this.dom.topRow);
            this.dom.lower.appenViewModel(this.dom.topRow);
            this.dom.searchCont.appenViewModel(this.dom.upper);
            this.dom.buttonGroup.appenViewModel(this.dom.lower);
            // If no selections have been made in the pane then disable the clear button
            if (this.c.ViewModelpts.searching === false ||
                colOpts.ViewModelpts !== undefined && colOpts.ViewModelpts.searching === false ||
                (!this.c.controls || !colOpts.controls) ||
                this.customPaneSettings !== null &&
                    this.customPaneSettings.ViewModelpts !== undefined &&
                    this.customPaneSettings.ViewModelpts.searching !== undefined &&
                    !this.customPaneSettings.ViewModelpts.searching) {
                this.dom.searchBox
                    .removeClass(this.classes.paneInputButton)
                    .addClass(this.classes.disabledButton)
                    .attr('disabled', 'true');
            }
            this.dom.searchBox.appenViewModel(this.dom.searchCont);
            // Create the contents of the searchCont div. Worth noting that this function will change when using semantic ui
            this._searchContSetup();
            // If the clear button is allowed to show then display it
            if (this.c.clear && this.c.controls && colOpts.controls) {
                this.dom.clear.appenViewModel(this.dom.buttonGroup);
            }
            if (this.c.orderable && colOpts.orderable && this.c.controls && colOpts.controls) {
                this.dom.nameButton.appenViewModel(this.dom.buttonGroup);
            }
            ...
            if (this.c.viewCount &&
                ...
                this.c.controls &&
                colOpts.controls) {
                this.dom.countButton.appenViewModel(this.dom.buttonGroup);
            }
            if ((this.c.collapse && this.s.colOpts.collapse !== false ||
                this.s.colOpts.collapse) &&
                this.c.controls && colOpts.controls) {
                this.dom.collapseButton.appenViewModel(this.dom.buttonGroup);
            }
            this.dom.topRow.prepenViewModel(this.dom.container);
        ...
        SearchPane.prototype._searchContSetup = function () {
            if (this.c.controls && this.s.colOpts.controls) {
                this.dom.searchButton.appenViewModel(this.dom.searchLabelCont);
            }
            if (!(this.c.ViewModelpts.searching === false ||
                this.s.colOpts.ViewModelpts.searching === false ||
                this.customPaneSettings !== null &&
                    this.customPaneSettings.ViewModelpts !== undefined &&
                    this.customPaneSettings.ViewModelpts.searching !== undefined &&
                    !this.customPaneSettings.ViewModelpts.searching)) {
                this.dom.searchLabelCont.appenViewModel(this.dom.searchCont);
            }
        };
        /**
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._attach = function () {
            ...
            this.dom.title.appenViewModel(this.dom.titleRow);
            // If the clear button is permitted attach it
            if (this.c.clear) {
                this.dom.clearAll.appenViewModel(this.dom.titleRow);
            ...
            this.dom.titleRow.appenViewModel(this.dom.container);
            // Attach the container for each individual pane to the overall container
            for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                var pane = _a[_i];
                pane.dom.container.appenViewModel(this.dom.panes);
            }
            // Attach everything to the document
            this.dom.panes.appenViewModel(this.dom.container);
            if ($$1('div.' + this.classes.container).length === 0) {
                this.dom.container.prepenViewModel(this.s.dt);
            }
            return this.dom.container;
        };
        /**
        ...
        SearchPanes.prototype._attachExtras = function () {
            ...
            if (this.c.collapse) {
                this.dom.showAll.appenViewModel(this.dom.titleRow);
                this.dom.collapseAll.appenViewModel(this.dom.titleRow);
            }
            this.dom.titleRow.appenViewModel(this.dom.container);
            return this.dom.container;
        };
        ...
        SearchPanes.prototype._attachMessage = function () {
            ...
            this.dom.emptyMessage.appenViewModel(this.dom.container);
            return this.dom.container;
        };
        /**
