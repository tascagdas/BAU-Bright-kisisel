    ...
    */
    ...
    var Emitter = /** @class */ (function () {
        ...
        Emitter.prototype.on = function (type, handler) {
            adViewModelHash(this.handlers, type, handler);
        };
    ...
    function adViewModelHash(hash, type, handler) {
        (hash[type] || (hash[type] = []))
            .push(handler);
    }
    ...
    */
    ...
    var CalendarContent = /** @class */ (function (_super) {
        ...
        function CalendarContent() {
            ...
            _this.builViewModelolbarProps = memoize(builViewModelolbarProps);
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            var toolbarProps = this.builViewModelolbarProps(props.viewSpec, props.dateProfile, props.dateProfileGenerator, props.currentDate, getNow(props.options.now, props.dateEnv), // TODO: use NowTimer????
                props.viewTitle);
            var viewVGrow = false;
            var viewHeight = '';
            var viewAspectRatio;
    ...
    function builViewModelolbarProps(viewSpec, dateProfile, dateProfileGenerator, currentDate, now, title) {
    ...
    */
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        Popover.prototype.updateSize = function () {
            ...
            var _a = this.props, alignmentEl = _a.alignmentEl, alignGriViewModelp = _a.alignGriViewModelp;
            var rootEl = this.rootEl;
            var alignmentRect = computeClippedClientRect(alignmentEl);
            if (alignmentRect) {
                var popoverDims = rootEl.getBoundingClientRect();
                // position relative to viewport
                var popoverTop = alignGriViewModelp
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: startDate, dateProfile: dateProfile, todayRange: todayRange, elRef: this.handleRootEl }, function (rootElRef, dayClassNames, dataAttrs) {
                return (createElement(Popover, { elRef: rootElRef, id: props.id, title: title, extraClassNames: ['fc-more-popover'].concat(dayClassNames), extraAttrs: dataAttrs /* TODO: make these time-based when not whole-day? */, parentEl: props.parentEl, alignmentEl: props.alignmentEl, alignGriViewModelp: props.alignGriViewModelp, onClose: props.onClose },
        ...
        MoreLinkRoot.prototype.render = function () {
            ...
            return (createElement(ViewContextType.Consumer, null, function (context) {
                ...
                return (createElement(Fragment, null,
                    ...
                    state.isPopoverOpen && (createElement(MorePopover, { id: state.popoverId, startDate: range.start, endDate: range.end, dateProfile: props.dateProfile, todayRange: props.todayRange, extraDateSpan: props.extraDateSpan, parentEl: _this.parentEl, alignmentEl: props.alignmentElRef.current, alignGriViewModelp: props.alignGriViewModelp, onClose: _this.handlePopoverClose }, props.popoverContent()))));
            }));
        };
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            if (settings.appenViewModel != null) {
                dragging.mirror.parentNode = settings.appenViewModel; // TODO: write tests
            }
            dragging.emitter.on('pointerdown', this.handlePointerDown);
            dragging.emitter.on('dragstart', this.handleDragStart);
    ...
    var TableCellMoreLink = /** @class */ (function (_super) {
        ...
        TableCellMoreLink.prototype.render = function () {
            ...
            return (createElement(MoreLinkRoot, {
                dateProfile: props.dateProfile, todayRange: props.todayRange, allDayDate: props.allDayDate, moreCnt: props.moreCnt, allSegs: allSegs, hiddenSegs: invisibleSegs, alignmentElRef: props.alignmentElRef, alignGriViewModelp: props.alignGriViewModelp, extraDateSpan: props.extraDateSpan, popoverContent: function () {
                    ...
                    createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                        ...
                        createElement("div", { className: "fc-daygrid-day-events", ref: props.fgContentElRef },
                            ...
                            createElement("div", { className: "fc-daygrid-day-bottom", style: { marginTop: props.moreMarginTop } },
                                createElement(TableCellMoreLink, { allDayDate: date, singlePlacements: props.singlePlacements, moreCnt: props.moreCnt, alignmentElRef: rootElRef, alignGriViewModelp: !props.showDayNumber, extraDateSpan: props.extraDateSpan, dateProfile: props.dateProfile, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, todayRange: props.todayRange }))),
