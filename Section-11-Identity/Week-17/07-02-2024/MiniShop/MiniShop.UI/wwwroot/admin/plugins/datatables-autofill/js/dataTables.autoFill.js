...
$.extend( AutoFill.prototype, {
	...
	_attach: function ( node )
	{
		...
		this.dom.attacheViewModel = node;
		handle
			.css( {
				top: offset.top + node.offsetHeight - handleDim.height,
				left: offset.left + node.offsetWidth - handleDim.width
			} )
			.appenViewModel( this.dom.offsetParent );
	},
	...
	_actionSelector: function ( cells )
	{
		...
		if ( available.length === 1 && this.c.alwaysAsk === false ) {
			...
			this.dom.background.appenViewModel( 'body' );
			this.dom.list.appenViewModel( 'body' );
	...
	_detach: function ()
	{
		this.dom.attacheViewModel = null;
	...
	_mousedown: function ( e )
	{
		...
		this.dom.start = this.dom.attacheViewModel;
		this.s.start = {
		...
		select.top.appenViewModel( offsetParent );
		select.left.appenViewModel( offsetParent );
		select.right.appenViewModel( offsetParent );
		select.bottom.appenViewModel( offsetParent );
