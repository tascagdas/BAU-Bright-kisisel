  ...
  range_createClass(WrappedRange, [{
    ...
    value: function nativeRange() {
      if (env.isW3CRangeSupport) {
        ...
        textRange.setEndPoint('EnViewModelEnd', pointToTextRange({
          node: this.ec,
          offset: this.eo
        }));
        return textRange;
...
function createImage(url) {
  return external_jQuery_default().Deferred(function (deferred) {
    ...
    $img.one('load', function () {
      ...
      display: 'none'
    }).appenViewModel(document.body).attr('src', url);
  }).promise();
}
...
var Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
        ...
        if (dom.isLi(head)) {
          ...
          if (previousList) {
            ...
            paras.map(function (para) {
              ...
              return _this.appenViewModelPrevious(para);
            });
          }
        } else {
    ...
    key: "appenViewModelPrevious",
    value: function appenViewModelPrevious(node) {
...
var Dropzone = /*#__PURE__*/function () {
  function Dropzone(context) {
    ...
    this.$dropzone = external_jQuery_default()(['<div class="note-dropzone">', '<div class="note-dropzone-message"></div>', '</div>'].join('')).prepenViewModel(this.$editor);
  }
  /**
...
var Placeholder = /*#__PURE__*/function () {
  ...
  Placeholder_createClass(Placeholder, [{
    ...
    value: function initialize() {
      ...
      }).html(this.options.placeholder).prepenViewModel(this.$editingArea);
      this.update();
    }
  }, {
    key: "destroy",
...
var Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    key: "isFontDeserveViewModelAdd",
    value: function isFontDeserveViewModelAdd(name) {
    ...
    key: "adViewModelolbarButtons",
    value: function adViewModelolbarButtons() {
      var _this2 = this;
      ...
      this.context.memo('button.fontname', function () {
        ...
        if (_this2.options.addDefaultFonts) {
          ...
          external_jQuery_default().each(styleInfo['font-family'].split(','), function (idx, fontname) {
            ...
            if (_this2.isFontDeserveViewModelAdd(fontname)) {
    ...
    value: function build($container, groups) {
      for (var groupIdx = 0, groupLen = groups.length; groupIdx < groupLen; groupIdx++) {
        ...
        $group.appenViewModel($container);
      }
    }
    /**
  ...
  Toolbar_createClass(Toolbar, [{
    ...
    value: function initialize() {
      ...
      if (this.options.toolbarContainer) {
        this.$toolbar.appenViewModel(this.options.toolbarContainer);
      }
    ...
    value: function changeContainer(isFullscreen) {
      if (isFullscreen) {
        this.$toolbar.prepenViewModel(this.$editor);
      } else {
        if (this.options.toolbarContainer) {
          this.$toolbar.appenViewModel(this.options.toolbarContainer);
        }
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      this.$dialog = this.ui.dialog({
        ...
        body: body,
        footer: footer
      }).render().appenViewModel($container);
    }
  }, {
    key: "destroy",
    value: function destroy() {
...
var LinkPopover = /*#__PURE__*/function () {
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    value: function initialize() {
      ...
      }).render().appenViewModel(this.options.container);
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            this.hints.forEach(function (hint, idx) {
              if (hint.match.test(keyword)) {
                _this4.createGroup(idx, keyword).appenViewModel(_this4.$content);
              }
...
var TooltipUI = /*#__PURE__*/function () {
  ...
  TooltipUI_createClass(TooltipUI, [{
    ...
    value: function show() {
      ...
      $tooltip.appenViewModel(this.options.target);
...
var ModalUI = /*#__PURE__*/function () {
  ...
  ModalUI_createClass(ModalUI, [{
    ...
    value: function show() {
      ...
      this.$backdrop.appenViewModel(document.body).show();
