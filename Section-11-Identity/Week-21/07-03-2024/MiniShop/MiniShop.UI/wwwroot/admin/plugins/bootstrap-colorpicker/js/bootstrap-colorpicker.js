...
Color.prototype = {
	...
	round: function (places) {
		...
		return new Color(this.color.map(rounViewModelPlace(places)).concat(this.valpha), this.model);
	},
...
function rounViewModel(num, places) {
	return Number(num.toFixed(places));
}

function rounViewModelPlace(places) {
	return function (num) {
		return rounViewModel(num, places);
	};
}
...
var PickerHandler = function () {
  ...
  _createClass(PickerHandler, [{
    ...
    value: function attach() {
      ...
      if (pickerParent) {
        this.picker.appenViewModel(pickerParent);
      }
    }
  }, {
    key: 'unbind',
