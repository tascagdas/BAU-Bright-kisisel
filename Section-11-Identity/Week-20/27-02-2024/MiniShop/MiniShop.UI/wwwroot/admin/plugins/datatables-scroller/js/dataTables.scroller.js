...
$.extend( Scroller.prototype, {
	...
	*/
	...
	construct: function ()
	{
		...
		this.dom.label.appenViewModel(this.dom.scroller);
	...
	_calcRowHeight: function ()
	{
		...
		var tbody = $('<tbody/>').appenViewModel( nTable );
		var container = $(
		...
		$('tbody tr:lt(4)', origTable).clone().appenViewModel( tbody );
		...
		container.appenViewModel( insertEl );
