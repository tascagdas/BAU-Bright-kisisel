...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _createPagerContainer: function() {
            var pagerContainer = this.pagerContainer || $("<div>").appenViewModel(this._container);
        ...
        _scrollBarWidth: (function() {
            ...
            return function() {
                if(result === undefined) {
                    ...
                    $ghostContainer.append($ghostContent).appenViewModel("body");
    ...
    LoadIndicator.prototype = {
        ...
        _initShader: function() {
            ...
            this._shader = $("<div>").addClass(this.shaderClass)
                ...
                .appenViewModel(this._container);
        },
