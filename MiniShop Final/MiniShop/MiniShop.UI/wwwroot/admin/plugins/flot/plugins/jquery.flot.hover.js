...
(function($) {
    ...
    function init(plot) {
        ...
        function generatePlothoverEvent(e) {
            ...
            newEvent.pageX = e.detail.changeViewModeluches[0].pageX;
            newEvent.pageY = e.detail.changeViewModeluches[0].pageY;
            newEvent.clientX = e.detail.changeViewModeluches[0].clientX;
            newEvent.clientY = e.detail.changeViewModeluches[0].clientY;
