...
namespace MiniShop.Data.Concrete.Configs
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(p => p.Price).IsRequired().HasColumnType("real"); // sqlite icin

            // builder.Property(p => p.CreatedDate).HasDefaultValueSql("getdate()"); //SQLserver icin
            builder.Property(p => p.CreatedDate).HasDefaultValueSql("date('now')"); //sqlite icin
            builder.Property(p => p.ModifiedDate).HasDefaultValueSql("date('now')"); //sqlite icin
